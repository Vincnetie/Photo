...
class HomeAction
{
    ...
    private function createPhotosTable(): void
    {
        ...
        if ($existingRecords == 0) {
            ...
            (1, 'Тверская 9', '55.75985606898725,37.61054750000002', '404.gif'),
            (2, 'Тверская, 20', '55.766642568974845,37.60237299999997', '404.gif'),
            (3, 'Охотный Ряд, 1', '55.75805306898262,37.6160005', '404.gif'),
            (4, 'Солянка, 16', '55.75061056899327,37.64180899999995', '404.gif')";
