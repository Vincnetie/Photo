...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (window.location.pathname === '/upload') {
    var myDropzone = new dropzone__WEBPACK_IMPORTED_MODULE_0__["default"]("#myDropzone", {
      url: "/upload",
      // Замените на URL, куда вы хотите отправлять загруженные файлы
      autoProcessQueue: false,
      // Отключение автоматической загрузки файлов
      maxFilesize: 10,
      ...
      addRemoveLinks: true,
      // Отображение ссылок для удаления загруженных файлов
